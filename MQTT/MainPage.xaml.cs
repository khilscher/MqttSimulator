...
namespace MQTT
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Publish()
        {
            ...
            if (client != null && client.IsConnected)
            {
                while (publish)
                {
                    ...
                    Telemetry msgObj = new Telemetry
                    {
                        engineTemp = temp,
                        engineRpm = rpm,
                        fuel = fuel_level
        ...
        // Update rpm based on slider value
        private void sliderRpm_ValueChanged(object sender, Windows.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            rpm = e.NewValue;
        }
